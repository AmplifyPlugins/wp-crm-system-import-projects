...
= 2.2.2 =
* Update: Software licensing script updated to avoid conflicts with other plugins.
...
= 2.0.3 =
* Update: Improved exports with Titles of associated records in addition to the record's ID number.
...
= 1.1.0 =
* Included ability to assign projects to categories.
